Sonar Custom Rules Examples [![Build Status](https://travis-ci.org/SonarqubeGeekshubs/sonar-custom-rules-examples.svg?branch=add-new-rules)](https://travis-ci.org/SonarqubeGeekshubs/sonar-custom-rules-examples)
==========
