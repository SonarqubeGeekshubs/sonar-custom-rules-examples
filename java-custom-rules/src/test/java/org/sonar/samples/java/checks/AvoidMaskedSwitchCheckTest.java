...
public class AvoidMaskedSwitchCheckTest {

    @Test
    public void detected() {

        // Use an instance of the check under test to raise the issue.
        AvoidMaskedSwitchCheck check = new AvoidMaskedSwitchCheck();
        ...
        JavaCheckVerifier.verify("src/test/files/AvoidMaskedSwitchCheck.java", check);
    }
}
